...
**빅데이터 분석 및 웹 개발 실무 프로젝트**이며,  

저는 팀장을 맡아  
데이터 전처리, DB 설계 및 연동, SpringBoot 내 Python 연동, 게시판 및 캐릭터 CRUD,  
메인페이지, 본인확인 페이지, 마이페이지, 성격유형 테스트 페이지 구현 등을 수행하였습니다.  
...
→ [크롬](http://131.186.16.4:8080/main)에서 서비스 체험하기 (DB배포 및 일부 기능 점검 중)

※ 프로젝트 깃허브 : [Verdeterr2](https://github.com/gonekng/Verdeterr2)
